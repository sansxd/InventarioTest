...
if(isset($_POST['update'])){
        ...
        $tipodetinta	= mysqli_real_escape_string($conn,(strip_tags($_POST['tipodetinta'], ENT_QUOTES)));
				...
				//$update = mysqli_query($conn,"UPDATE inventario SET PISO ='$piso', MARCA='$marca', SERIAL_PC='$serial', N_INTERNO_INVENTARIO='$nro_interno',MONITOR='$monitor',MOUSE='$mouse',TECLADO='$teclado',ADAPTADOR='$adaptador',RJ45='$rj45',NOMBRE='$nombre',TELEFONO='$telefono',IP='$ip',MAC='$mac',ANTIVIRUS='$antivirus',IMPRESORA='$impresora',TINTA='$tinta',TIPODETINTA='$tipodetinta' WHERE ID_INVENTARIO = $id")or die(mysqli_error());
